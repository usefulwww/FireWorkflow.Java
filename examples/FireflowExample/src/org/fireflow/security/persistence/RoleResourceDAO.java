 ...
 * 
 * @see org.fireflow.security.persistence.RoleResource
 * @author MyEclipse Persistence Tools
 */

public class RoleResourceDAO extends HibernateDaoSupport {
	private static final Log log = LogFactory.getLog(RoleResourceDAO.class);
	// property constants
	...
	public List findByResourceCode(Object resourceCode) {
		return findByProperty(RESOURCE_CODE, resourceCode);
	}
