...
create table T_FF_DF_WORKFLOWDEF (ID varchar(50) not null, PROCESS_ID varchar(100) not null, DEFINITION_TYPE varchar(100) not null, NAME varchar(100) not null, DISPLAY_NAME varchar(128) null, DESCRIPTION varchar(1024) null, VERSION int not null, STATE tinyint not null, UPLOAD_USER varchar(50) null, UPLOAD_TIME datetime null, PUBLISH_USER varchar(50) null, PUBLISH_TIME datetime null, PROCESS_CONTENT text null, primary key (ID));
